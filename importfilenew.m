function tableout = importfilenew(workbookFile,sheetName,startRow,endRow)
...
%% Import the data
data = xlsread(workbookFile, sheetName, sprintf('A%d:K%d',startRow(1),endRow(1)));
for block=2:length(startRow)
    tmpDataBlock = xlsread(workbookFile, sheetName, sprintf('A%d:K%d',startRow(block),endRow(block)));
...
tableout.Lac_downf_area_sum = data(:,11);
