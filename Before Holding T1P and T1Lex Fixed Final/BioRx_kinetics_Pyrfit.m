...
X0 = [1/48,0.01,0.17,...    %1/T1P, Kpl,FlowPyr
...
lb = [1/55,0.001,0.005,...       %[1/50, .00001,0.005,...%.0001, .01,...
      X0(4)-2, 11, 1e3];
ub = [1/48,0.5,0.3,...           %[1/46,.1,0.3,...
      X0(4)+2, 22, 1e10];
...
result_vector = [1/X(1),Flow,Kpl,X(4),X(5),X(6),rmse_pyr,Rsqrd_pyr_total]
