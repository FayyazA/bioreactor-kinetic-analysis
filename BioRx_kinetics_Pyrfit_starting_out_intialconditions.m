function [X,Sfit_dyn,results]=BioRx_kinetics_Pyrfit_starting_out_intialconditions(S_dyn,filename,x0vector)
...
X0 = [x0vector(1),x0vector(2),x0vector(3),...    %1/T1P, Kpl,FlowPyr
    x0vector(10),x0vector(11),x0vector(12)];  % alpha beta and constant values of gmma fit of input function
