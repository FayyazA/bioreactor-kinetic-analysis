function result = run_multiple_files_Tissue_slices_confirmation_lactatefraction()
...
for k = 1 : length(theFiles)
    ...
    [C,S_fitdyn2] = Tissue_slices_with_fraction_tissues(my_array,X,strcat(theFiles(k),"LacTissue")); %[round2_output,fit2,results2] = BioRx_kinetics_Lacin_NoT1Lin(my_array,round1_output,strcat(theFiles(k),"Lacincs"));
    lacin_table(k,:) = C;
...
xlswrite("LacTissue0322lactatefractionconfirmation.xlsx",lacin_table)
