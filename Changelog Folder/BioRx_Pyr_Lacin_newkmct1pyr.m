function [X,Sfit_dyn]=BioRx_Pyr_Lacin_newkmct1pyr(S_dyn,A,filename)
...
% Inital conditions
    Mest_dyn(:,1) = S_dyn(:,1);
       ...
       K  = [-x(1)-x(2)-0.5-x(3),x(5);... %Pyr=P(-R1P-kpl-Flow-KMCT1pyr)+Lac_in(Klp)
