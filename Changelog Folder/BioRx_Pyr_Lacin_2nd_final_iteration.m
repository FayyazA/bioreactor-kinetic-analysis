function [X,Sfit_dyn]=BioRx_Pyr_Lacin_2nd_final_iteration(S_dyn,A,filename)
...
X0 = [A(1),A(2),A(3),...    %1/T1Pyr, Kpl, Flow
    1/25, 0.45, .05]; %1/T1Lin, Klp=0, K(MCT4)
...
% Inital conditions
    Mest_dyn(:,1) = S_dyn(:,1);
       ...
       K  = [-1/48.61-x(2)-x(3),x(5);... %Pyr=P(-R1P-kpl-Flow)+Lac_in(Klp)
