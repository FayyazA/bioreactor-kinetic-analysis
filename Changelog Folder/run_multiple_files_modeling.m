...
theFiles = ["HK2_1_062714_LBp5","HK2_2_062714_LBp5","HK2B_1_062714_LBp5","UMRC6_1_C1Pyr_062714_LBp5","UMRC6_2_C1Pyr_062714_LBp5","UMRC6B_1_C1Pyr_062714_LBp5","UOK262_100813_1_LBp5","UOK262_100813B_1_LBp5","UOK262_042514_6_LBp5","NewUOKDataset","13C_3_uok262_101113_with_auto","13C_1_C1Pyr_uok262_102213_with_"]
...
for k = 1 : length(theFiles)
    ...
    [X,S_fit_dyn] = BioRx_kinetics_Pyrfit_starting_out(input_vector,strcat(theFiles(k),"PyrFINALsmooth"));
    ...
    [C,S_fitdyn2] = BioRx_Pyr_Lacin(my_array,X,strcat(theFiles(k),"LacinFINALsmooth")); %[round2_output,fit2,results2] = BioRx_kinetics_Lacin_NoT1Lin(my_array,round1_output,strcat(theFiles(k),"Lacincs"));
    lacin_table(k,:) = C;
...
xlswrite("Lacin_summary_FINALsmooth_confirmation_optimized.xlsx",lacin_table)
xlswrite("Lacex_summary_FINALsmooth_confirmation_optimized.xlsx",lacex_table)
