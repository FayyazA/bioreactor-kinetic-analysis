function [X,Sfit_dyn,results]=BioRx_kinetics_Pyrfit_starting_out_newkmct1pyr(S_dyn,filename)
...
% Inital conditions
    ...
    K  = [-x(1)-x(2)-0.5-x(3)] ; %Pyr=P(-R1P-kpl-Flow-kmct1pyr)                  Setting Rate Constant of dpyr = k * pyr
