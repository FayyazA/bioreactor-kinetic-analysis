...
xlswrite("Lacin_summary_FinalConfirmation_moredata.xlsx",lacin_table)
xlswrite("Lacex_summary_FinalConfirmation_moredata.xlsx",lacex_table)
xlswrite("AIC9parameters_FinalConfirmation_moredata.xlsx",AIC_vec)
