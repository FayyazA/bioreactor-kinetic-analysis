function [E,Sfit_dyn]=BioRx_3mets_Lac2pks(S_dyn,A,C)
...
lb = [C(1)-.001, .0001, C(3)*.9,... % 1/T1Pyr, Kpl, Flow_pyr
      C(4)-.001, 0, 0.001,... %1/T1Lin, Klp, K(MCT4)
      1/37.7, 0.08, 0]; % 1/T1Lout,Flow_lacout, K(MCT1)
 ub = [C(1)+.001, 0.08, C(3)*1.1,... % 1/T1Pyr, Kpl, Flow_pyr
      C(4)+.001, 0.1, 0.8,... %1/T1Lin, Klp, K(MCT4)
      1/35.7, 0.9, .9]; % 1/T1Lout,Flow_lacout, K(MCT1)
