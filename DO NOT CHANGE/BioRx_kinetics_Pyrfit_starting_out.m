function [X,Sfit_dyn]=BioRx_kinetics_Pyrfit_starting_out(S_dyn)
...
X0 = [1/48,0.01,0.15,...    %1/T1P, Kpl,FlowPyr
    3,19,5e8];  % alpha beta and constant values of gmma fit of input function
...
% This should be optimized MaxIter was 50000
opts = optimset('MaxIter',20000,'MaxFunEvals', 1e32,'TolX',1e-9,'TolFun', min(abs(S_dyn(:,end)))/1e15,'FinDiffType','central','Display','iter');
