function result = run_multiple_files_modeling_tight_Fl_bounds()
...
for k = 1 : length(theFiles)
    ...
    [E,Sfitdyn3] = BioRx_3mets_Lac2pks_tight_Fl_bounds(my_array_2,X,C,strcat(theFiles(k),"LacexFINALsmooth")); %[fit3,results3] = BioRx_kinetics_Lac2pks_NoT1s(my_array_2,round1_output,round2_output,strcat(theFiles(k),"Lacexcs"));
    lacex_table(k,:) = E;
  drawnow; % Force display to update immediately.
end
%xlswrite("Pyr_summarycsmath.xlsx",pyr_table)
xlswrite("Lacin_summary_tight_Fl_bounds1.xlsx",lacin_table)
xlswrite("Lacex_summary_tight_Fl_bounds1.xlsx",lacex_table)
