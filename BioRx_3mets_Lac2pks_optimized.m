function [E,Sfit_dyn]=BioRx_3mets_Lac2pks_optimized(S_dyn,A,C,filename)
...
lb = [1/51, .0001, 10^-8,... % 1/T1Pyr, Kpl, Flow_pyr Flow_pyr used to be C(3)*0.9 1/T1P was C(1)-.001
 ...
 ub = [1/47, 1, 10.0,... % 1/T1Pyr, Kpl, Flow_pyr Flow_pyr used to be C(3)*1.1 1/T1P was C(1)-.001
      C(4)+.001, 0.01, 10.0,... %1/T1Lin, Klp, K(MCT4)
