function [X,Sfit_dyn,results]=BioRx_kinetics_Pyrfit_starting_out_starting_point_increments(S_dyn,filename,xknot,kinetic_paramter)
...
if kinetic_paramter == "R1P"
    X0 = [xknot,0.01,0.15,...
        (2/skewness(S_dyn(1,:)))^2,19,5e8];
elseif kinetic_paramter == "kPL"
    X0 = [1/48,xknot,0.15,...
        (2/skewness(S_dyn(1,:)))^2,19,5e8];
