function [X,Sfit_dyn,result_vector]=BioRx_kinetics_Pyrfit_completelysimplified(S_dyn,filename)
...
X0 = [0.12257,0,0,...    %1/T1P, Kpl,FlowPyr
...
% Inital conditions
    ...
    K  = [-x(1)] ; %Pyr=P(-R1P-kpl-Flow)                  Setting Rate Constant of dpyr = k * pyr
...
lb = [0.026, -10^-20,-10^-20,...%[0.01, -10^-20,-10^-20,...%.0001, .01,...
      X0(4)-2, 11, 1e3];
ub = [0.8+1/45,10^-20,10^-20,...%[0.30,10^-20,10^-20,...
      X0(4)+2, 22, 1e10];
...
result_vector = [T1_Kpl_Flow,Flow,Kpl,X(4),X(5),X(6),rmse_pyr,Rsqrd_pyr_total]
