...
for k = 1 : length(theFiles)
    ...
    [params_fit, Sfit, ufit, error_metrics] = fit_pyr_kinetics_and_input_Lacin_Lacex(my_array_2,3,ones(3,size_table(2)-1) * 30,params_fixed,params_est,[],true,theFiles(k));
    Sfit = squeeze(Sfit);
    for i=1:3
