function [E,Sfit_dyn]=BioRx_3mets_Lac2pks_starting_point_increments(S_dyn,A,C,filename,xknot,kinetic_paramter)
...
if kinetic_paramter == "R1Lex"
    X0 = [C(1), C(2), C(3),...
        C(4), C(5), 0.03,...
        xknot, C(3)*4, 0];
elseif kinetic_paramter == "FL"
    X0 = [C(1), C(2), C(3),...
        C(4), C(5), 0.03,...
        1/36.7, xknot, 0];
elseif kinetic_paramter == "kMCT1"
    X0 = [C(1), C(2), C(3),...
        C(4), C(5), 0.03,...
        1/36.7, C(3)*4, xknot];
else
